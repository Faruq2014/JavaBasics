...
public class UpcastingAndDowncasting {
	...
	int balance =4000;//uper level than byte
	byte money=24;
	int total= balance+money;
	System.out.println(total);
	// this is up casting mean uper level data type can easily hold lower level data type
	
	byte total1= (byte) (balance+money);
	System.out.println(total1);
	
	//this is down casting means if we force to hold uper level data to lower level data
